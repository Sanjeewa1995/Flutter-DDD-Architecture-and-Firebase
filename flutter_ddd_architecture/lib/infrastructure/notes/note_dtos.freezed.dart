...
// ignore: unused_element
  _NoteDto call(
      {@JsonKey(ignore: true) String tId,
...
class _$NoteDtoCopyWithImpl<$Res> implements $NoteDtoCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      tId: tId == freezed ? _value.tId : tId as String,
...
class _$_NoteDto extends _NoteDto {
  ...
  @override
  String toString() {
    return 'NoteDto(tId: $tId, body: $body, color: $color, todos: $todos, serverTimeStamp: $serverTimeStamp)';
  }
...
// ignore: unused_element
  _TodoItemDto call(
      {@required String tId, @required String name, @required bool done}) {
    return _TodoItemDto(
      tId: tId,
      name: name,
      done: done,
...
abstract class $TodoItemDtoCopyWith<$Res> {
  ...
  $Res call({String tId, String name, bool done});
}
...
class _$_TodoItemDto extends _TodoItemDto {
  const _$_TodoItemDto(
      {@required this.tId, @required this.name, @required this.done})
      : assert(tId != null),
        assert(name != null),
        assert(done != null),
        super._();
  ...
  @override
  String toString() {
    return 'TodoItemDto(tId: $tId, name: $name, done: $done)';
  }
